  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError('Gagal menyimpan: ' + (errorData.message || 'Unknown error'));
      }
    } catch (err) {
  ...
  return (
    <div className="animate-fade-in-up">
      <header className="mb-20">
        ...
        <span className="text-brass font-black tracking-[0.4em] uppercase text-[10px] mb-4 block">Strategic Registration</span>
        <h1 className="text-5xl font-black text-white tracking-tighter uppercase leading-none">Registrasi <br/>Proyek Baru.</h1>
        <p className="text-white/30 text-[10px] mt-4 uppercase tracking-[0.2em] font-black italic">Mendaftarkan Proyek Baru ke Manifest Strategis</p>
      </header>
        ...
        <section className="space-y-10">
          ...
          <div className="space-y-4">
            ...
            <input
              ...
              required
              placeholder="Ex: Proyek Dermaga Pelabuhan Utama"
            />
          </div>

          <div className="space-y-4">
            <label className="text-[9px] font-black uppercase tracking-[0.3em] text-white/30 pl-8">Deskripsi Proyek *</label>
            <textarea
              rows={6}
              ...
              required
              placeholder="Tuliskan deskripsi strategis proyek ini..."
            />
          </div>
            ...
            <label className="block w-full bg-[#001f3f] border-2 border-dashed border-white/10 rounded-[3rem] px-12 py-12 text-center cursor-pointer hover:border-brass/30 transition-all duration-500 group">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20 group-hover:text-white/40 transition-colors">
                  {form.image ? form.image.name : 'Pilih atau Seret File Gambar'}
                </span>
              </div>
            </label>
          </div>
